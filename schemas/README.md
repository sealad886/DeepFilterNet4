...
- `[loss]` - Dynamic loss type, awesome loss, contrastive awesome, multi-res STFT
...
[loss]
dynamic_loss = "contrastive_awesome"  # Options: "baseline", "awesome", "pipeline_awesome", "contrastive_awesome"
