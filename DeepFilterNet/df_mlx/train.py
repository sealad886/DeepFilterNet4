...
from .metal_kernels import fused_complex_mag
...
def spectral_loss(
    ...
    pred_mag = fused_complex_mag(pred_real, pred_imag, eps=1e-8)
    target_mag = fused_complex_mag(target_real, target_imag, eps=1e-8)
