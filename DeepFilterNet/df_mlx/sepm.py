"""Speech enhancement performance metrics for df_mlx.

This module is intentionally mirrored from /df/sepm.py so df_mlx does not
depend on df internals while preserving equivalent metric behavior.
"""
