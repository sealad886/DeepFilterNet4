...
class TestModelParams4:
    ...
    def test_dfnet4_specific_params(self, standard_config):
        ...
        assert p.use_time_branch is False
        assert p.use_phase_branch is False or p.use_phase_branch is True  # May vary by config
...
class TestQuantization:
    ...
    def test_quantization_config(self):
        ...
        assert config2.per_channel is False
    ...
    def test_compare_model_sizes(self):
        ...
        from df.quantization import compare_model_sizes
    ...
    def test_qat_callback_init(self):
        ...
        assert callback.qat_active is False
