...
class TestMelSpectrogram:
    def test_output_shape(self, waveform):
        ...
        expected_frames = waveform.shape[-1] // 256 + 1
...
class TestLossGANIntegration:
    ...
    def test_compute_d_loss_with_disc(self, df_config):
        ...
        from df.loss import Loss, DiscriminatorLoss
        from libdf import DF
    ...
    def test_compute_g_loss_with_disc(self, df_config):
        ...
        from df.loss import Loss, GeneratorLoss, FeatureMatchingLoss
        from libdf import DF
    ...
    def test_gan_training_step_simulation(self, df_config):
        ...
        from df.loss import Loss, GeneratorLoss, DiscriminatorLoss, FeatureMatchingLoss
        from libdf import DF
